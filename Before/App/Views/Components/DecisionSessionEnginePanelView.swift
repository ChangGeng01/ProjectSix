...
struct DecisionSessionEnginePanelView: View {
    ...
    private func sessionBlock(
        ...
        DecisionSessionEngineSessionSummaryView(
            ...
            checkpointLungLine: session.replayRecoverySummary.lungLine,
            checkpointHotColdLine: session.replayRecoverySummary.hotColdLine,
            checkpointResumeLine: session.replayRecoverySummary.resumeLine,
            checkpointRollbackLine: session.replayRecoverySummary.rollbackLine,
            checkpointSovereignBridgeLine: session.replayRecoverySummary.sovereignBridgeLine,
            checkpointSovereignBridgeDetailLines: session.replayRecoverySummary.sovereignBridgeDetailLines,
