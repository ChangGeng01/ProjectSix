...
struct DecisionSessionEngineControlCenterView: View {
    ...
    private func sessionInventoryRow(
        ...
        DecisionSessionEngineSessionSummaryView(
            ...
            checkpointMorphLine: session.checkpointMorphLine,
            checkpointLungLine: session.checkpointLungLine,
            checkpointHotColdLine: session.checkpointHotColdLine,
            checkpointPrecisionLine: session.checkpointPrecisionLine,
            checkpointOrganPackageLine: session.checkpointOrganPackageLine,
            checkpointOrganDeltaLine: session.checkpointOrganDeltaLine,
            checkpointSchedulerLine: session.checkpointSchedulerLine,
            checkpointThermalExchangeLine: session.checkpointThermalExchangeLine,
            checkpointIntegrityWeaveLine: session.checkpointIntegrityWeaveLine,
        ...
        PanelCard {
            VStack(alignment: .leading, spacing: 12) {
                ...
                DecisionSessionEngineSessionSummaryView(
                    ...
                    checkpointWindGateLine: selectedSession.checkpointWindGateLine,
                    checkpointPresenceLine: selectedSession.checkpointPresenceLine,
                    ...
                    checkpointCourtLine: selectedSession.checkpointCourtLine,
                    ...
                    checkpointMorphLine: selectedSession.checkpointMorphLine,
                    checkpointLungLine: selectedSession.checkpointLungLine,
                    checkpointHotColdLine: selectedSession.checkpointHotColdLine,
                    checkpointPrecisionLine: selectedSession.checkpointPrecisionLine,
                    checkpointOrganPackageLine: selectedSession.checkpointOrganPackageLine,
                    checkpointOrganDeltaLine: selectedSession.checkpointOrganDeltaLine,
                    checkpointSchedulerLine: selectedSession.checkpointSchedulerLine,
                    checkpointThermalExchangeLine: selectedSession.checkpointThermalExchangeLine,
                    checkpointIntegrityWeaveLine: selectedSession.checkpointIntegrityWeaveLine,
