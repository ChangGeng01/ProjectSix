...
// chapter 二百七十八 / M765 — L6 situation-field cluster
// (BASContextTaskType / BASContextSceneType / BASRoleGeometry /
// BASPowerGradient / BASEmotionalWeather / BASUrgencyTruth /
// BASConsequenceHorizon / BASManipulationTrace /
// BASHostResonance / BASContinuityAnchor /
// BASContextRouteHint / BASSituationField / BASRouteHint /
// BASContextFrame) extracted to
// `EBrainL6SituationFieldCore.swift`. Phase Alpha 4th cut.
// 0 behavior change.


// chapter 二百七十九 / M766 — L7 mirror-blade + decompose
// cluster (M112 L7 whitepaper §5 parity + thought frame +
// thermal/integrity exchange + organ package) extracted to
// `EBrainL7MirrorBladeDecomposeCore.swift`. Phase Alpha 5th
