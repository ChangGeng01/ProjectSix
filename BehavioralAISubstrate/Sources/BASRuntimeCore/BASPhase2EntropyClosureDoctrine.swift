...
public enum BASPhase2EntropyClosureDoctrine {
    ...
    public static let mNumberLast: Int = 1768

    /// Cumulative commits shipped during Phase 2 (M953-
    /// M1768)。 Bumped through chapter 597:809 → 813。
    /// Chapter 597:Octa-milestone completion meta-meta
    /// + 36 anti-drift + 21 wire-in PROOF tests +
    /// close-out。
    public static let commitsShipped: Int = 813
