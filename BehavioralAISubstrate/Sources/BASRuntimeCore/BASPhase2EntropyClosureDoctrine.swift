...
public enum BASPhase2EntropyClosureDoctrine {
    ...
    public static let mNumberLast: Int = 1808

    /// Cumulative commits shipped during Phase 2 (M953-
    /// M1808)。 Bumped through chapter 607:849 → 853。
    /// Chapter 607:Post-octa hexa catalog meta-meta +
    /// 30 anti-drift + 14 wire-in PROOF tests + close-
    /// out。
    public static let commitsShipped: Int = 853
