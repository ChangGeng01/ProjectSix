// charter audit 2026-07-12 T4: pure Chenglu adapter cores (signature, feature
// encoder, closure-based make factories) moved to BASAppleLifecycleKit; the
// MLModel-bound make overloads + ModelBoxes stay in BASAppleAdapters
// (BASChengluCoreMLAdapters+CoreML.swift).
