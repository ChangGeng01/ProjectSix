...
final class BASDoctrineChainConsistencyTests: XCTestCase {
    ...
    func testDoctrineVersionMatchesLatestChapterMNumber() {
        ...
        // chapter 四百三十七 is the latest with mNumberLast
        // M1127 (POST-RADICAL Wave 8 — end-to-end routed
        // dispatch);the doctrine version should be M1127
        ...
        XCTAssertGreaterThanOrEqual(
            ...
            "chapter 四百三十七 at M\(BASChapter437EntropyDoctrine.mNumberLast))")
    }
