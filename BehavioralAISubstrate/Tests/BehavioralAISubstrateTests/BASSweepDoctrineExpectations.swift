...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)。 At M1840:24 + 20 + 169 = 213 (chapter
    /// 615 — BASLeaseLife Codable extension
    /// continuation gap-fill)
    public static let phase2ChapterCount: Int = 213

    /// Phase 2 commits shipped。 At M1840:125 + 84 +
    /// 676 = 885 (chapter 615 = 4 cuts — BASLeaseLife
    /// continuation gap-fill + 2 PROOF + typed surface
    /// + close-out)
    public static let phase2CommitsShipped: Int = 885

    /// Phase 2 mNumberLast。 At M1840:chapter 615 —
    /// BASLeaseLife Codable extension continuation
    /// gap-fill。 SWEEP stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1840
