...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)
    public static let phase2ChapterCount: Int = 83

    /// Phase 2 commits shipped。 At M1319:
    /// 125 + 84 + 156 = 365 (chapter 485 = 4 cuts)
    public static let phase2CommitsShipped: Int = 365

    /// Phase 2 mNumberLast。 At M1319:chapter 485
    /// ends here (V1 fold cluster A 12-of-18)。
    /// SWEEP stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1319
