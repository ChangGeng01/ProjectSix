...
public enum BASSweepDoctrineExpectations {
    ...
    /// At M1207:24 + 20 + 11 = 55
    public static let phase2ChapterCount: Int = 55

    /// Phase 2 commits shipped。 At M1207:
    /// 125 + 84 + 44 = 253 (chapters 447-457 each 4 cuts)
    public static let phase2CommitsShipped: Int = 253

    /// Phase 2 mNumberLast。 At M1207:chapter 457 ends
    /// here。 SWEEP stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1207
