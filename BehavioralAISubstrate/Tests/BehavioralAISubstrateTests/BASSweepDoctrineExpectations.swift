...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)。 At M1808:24 + 20 + 161 = 205 (chapter
    /// 607 — Post-octa hexa catalog meta-meta milestone)
    public static let phase2ChapterCount: Int = 205

    /// Phase 2 commits shipped。 At M1808:125 + 84 +
    /// 644 = 853 (chapter 607 = 4 cuts — Post-octa
    /// hexa catalog + 30 anti-drift + 14 wire-in PROOF
    /// + close-out)
    public static let phase2CommitsShipped: Int = 853

    /// Phase 2 mNumberLast。 At M1808:chapter 607 —
    /// Post-octa hexa catalog meta-meta milestone。
    /// SWEEP stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1808
