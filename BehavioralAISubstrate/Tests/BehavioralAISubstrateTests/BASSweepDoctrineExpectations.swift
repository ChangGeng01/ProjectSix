...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)。 At M1812:24 + 20 + 162 = 206 (chapter
    /// 608 — BASHostKit mesh-sweep Codable extension
    /// wave 1 — non-arc continuation)
    public static let phase2ChapterCount: Int = 206

    /// Phase 2 commits shipped。 At M1812:125 + 84 +
    /// 648 = 857 (chapter 608 = 4 cuts — BASHostKit
    /// mesh-sweep wave 1 + 3 PROOF + typed surface +
    /// close-out)
    public static let phase2CommitsShipped: Int = 857

    /// Phase 2 mNumberLast。 At M1812:chapter 608 —
    /// BASHostKit mesh-sweep Codable extension wave 1。
    /// SWEEP stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1812
