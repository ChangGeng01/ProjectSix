...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)。 At M1636:24 + 20 + 118 = 162 (chapter
    /// 564 — aggregator extension arc-seal milestone)
    public static let phase2ChapterCount: Int = 162

    /// Phase 2 commits shipped。 At M1636:125 + 84 +
    /// 472 = 681 (chapter 564 = 4 cuts — aggregator
    /// extension arc-seal milestone + 20 anti-drift +
    /// 13 wire-in PROOF tests + close-out)
    public static let phase2CommitsShipped: Int = 681

    /// Phase 2 mNumberLast。 At M1636:chapter 564 —
    /// aggregator extension arc-seal milestone。 SWEEP
    /// stays frozen at 1163。
    public static let phase2MNumberLast: Int = 1636
