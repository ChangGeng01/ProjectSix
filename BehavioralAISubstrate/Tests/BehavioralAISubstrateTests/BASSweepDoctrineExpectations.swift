...
public enum BASSweepDoctrineExpectations {
    ...
    /// added)。 At M1988:24 + 20 + 206 = 250 (chapter
    /// 652 — Mamba+federated-storage trio,3rd post-
    /// hexa-#6 gap-fill,cross-module)
    public static let phase2ChapterCount: Int = 250

    /// Phase 2 commits shipped。 At M1988:125 + 84 +
    /// 824 = 1033 (chapter 652 = 4 cuts — Mamba-
    /// federated-storage trio + 3 PROOF + typed
    /// surface + close-out)。
    public static let phase2CommitsShipped: Int = 1033

    /// Phase 2 mNumberLast。 At M1988:chapter 652 —
    /// Mamba+federated-storage trio。 SWEEP stays
    /// frozen at 1163。
    public static let phase2MNumberLast: Int = 1988
