    ...
    XCTestCase
{
    ...
    func testTypedSurfaceCountIsNinetyFive() {
        XCTAssertEqual(
            BASAutonomousSessionStateOfTheUnionDoctrine
                .typedSurfaceCount,
            95)
    ...
    func testConsecutiveByteEqualityCleanCommitsIs180() {
        XCTAssertEqual(
            BASAutonomousSessionStateOfTheUnionDoctrine
    ...
    func testPhase2CommitsShippedIs641() {
        XCTAssertEqual(
            BASAutonomousSessionStateOfTheUnionDoctrine
    ...
    func testChapter2NumberLastIs1596() {
        XCTAssertEqual(
            BASAutonomousSessionStateOfTheUnionDoctrine
                .chapter2NumberLast,
            1596)
