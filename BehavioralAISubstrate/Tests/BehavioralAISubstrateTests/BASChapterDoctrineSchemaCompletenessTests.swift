    ...
    XCTestCase
{
    ...
    func testEveryPhase2ChapterDoctrineHasFullSchemaORIGINAL() {
        ...
        [
            ...
            // M2246 chapter 733 — MAKE(FLAGS:) FACTORY
            checkRegistry("七百三十三",
                record: BASChapterDoctrineRegistry
                    .recordFor(
                        chapterTag: "chapter 七百三十三")!),
            // M2248 chapter 734 — FACTORY FLAG-STATE-DIV
            checkRegistry("七百三十四",
                record: BASChapterDoctrineRegistry
                    .recordFor(
...
#endif // chapter 七百五十二 第一刀 historical body end
}
