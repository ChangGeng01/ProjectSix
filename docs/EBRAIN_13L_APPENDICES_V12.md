...
>
> `L8 v∞` 目标态固定为：`Temporal Memory Ecology / Hippocampal Well`。详见 [EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md](/Users/changgeng/Project/Project06/Project06/docs/EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md) 与 [2026-04-19-l8-temporal-memory-field-stage-1-design.md](/Users/changgeng/Project/Project06/Project06/docs/superpowers/specs/2026-04-19-l8-temporal-memory-field-stage-1-design.md)。前者只定义理想完全体白皮书，后者描述当前 repo-real `Temporal Memory Field Stage 1`，不改写当前 repo 仍以 `MemoryAtom / MemoryBundle / DecisionMemoryRecord` 兼容投影、来源封印、情节弧线、冲突簇、回放摘要与 quarantine / sanctum / forget skeleton 为主的 `Alpha` 执行口径。
>
...
>
> `L11 v∞` 目标态固定为：`Risk Climate Field / Wind Gate`。详见 [EBRAIN_L11_WIND_GATE_TARGET_VINF.md](/Users/changgeng/Project/Project06/Project06/docs/EBRAIN_L11_WIND_GATE_TARGET_VINF.md) 与 [EBRAIN_L11_WIND_GATE_ROADMAP.md](/Users/changgeng/Project/Project06/Project06/docs/EBRAIN_L11_WIND_GATE_ROADMAP.md)。这两份文档分别用于定义 `L11` 的理想完全体白皮书与 repo-real 路线，不改写当前 repo 仍以 `BASRiskCard / BASActionPermit / BASRiskField / BASRiskDecisionPackage / compatibility projection / runtime audit / kill-switch lattice` 为主的 `Alpha` 执行口径。
>
