...
- [OpenAI Codex `0fb559f0f6e231a88ac02ea002d3ecd248e2b515`](https://github.com/openai/codex/tree/0fb559f0f6e231a88ac02ea002d3ecd248e2b515): typed lifecycle/event projection, bounded delivery/backpressure, exact steer correlation, dynamic capability disclosure, and model-neutral Provider profiles; Qinao rejects raw reasoning delivery and any interpretation of the live stream as K3 truth;
- [Pi `v0.80.10` / `8dc78834cde4e329284cf505f9e3f99763df5529`](https://github.com/earendil-works/pi/tree/8dc78834cde4e329284cf505f9e3f99763df5529): two-phase preparation/execution with every prepare completed before parallel execute, source-ordered tool-result messages, and separate abort/wait-for-idle/post-turn snapshot hooks; Qinao independently materializes those results as governed Artifacts, adds immutable post-prepare argument/currentness revalidation, rejects Pi's permitted post-validation argument mutation, and treats completion-order lifecycle/progress streams as non-authoritative;
