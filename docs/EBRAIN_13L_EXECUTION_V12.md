...
>
> 若需查看 `L8 海马井` 的理想完全体定义与 repo-real 第一阶段设计，请参考 [EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md](/Users/changgeng/Project/Project06/Project06/docs/EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md) 与 [2026-04-19-l8-temporal-memory-field-stage-1-design.md](/Users/changgeng/Project/Project06/Project06/docs/superpowers/specs/2026-04-19-l8-temporal-memory-field-stage-1-design.md)。前者是 `target-state whitepaper`，后者是 shipped `repo-real Stage 1` design reference；它们不改变本文对当前 `MemoryAtom / MemoryBundle / DecisionMemoryRecord / Temporal Memory Field Stage 1 / Alpha` 执行口径的表述。
>
