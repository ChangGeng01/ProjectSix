...
- The effort and process-view protocol now lives in [docs/QINAO_EFFORT_PROCESS_VIEW_PROTOCOL_TARGET_V1.md](/Users/changgeng/Project/Project06/Project06/docs/QINAO_EFFORT_PROCESS_VIEW_PROTOCOL_TARGET_V1.md).
- The multi-agent persona projection protocol now lives in [docs/QINAO_AGENT_PERSONA_PROJECTION_PROTOCOL_TARGET_V1.md](/Users/changgeng/Project/Project06/Project06/docs/QINAO_AGENT_PERSONA_PROJECTION_PROTOCOL_TARGET_V1.md).
...
- The `L8` hippocampal-well documents now live in [docs/EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md](/Users/changgeng/Project/Project06/Project06/docs/EBRAIN_L8_HIPPOCAMPAL_WELL_TARGET_VINF.md) and [docs/superpowers/specs/2026-04-19-l8-temporal-memory-field-stage-1-design.md](/Users/changgeng/Project/Project06/Project06/docs/superpowers/specs/2026-04-19-l8-temporal-memory-field-stage-1-design.md). The first is the `target-state` whitepaper; the second is the shipped `repo-real Stage 1` design reference. Neither changes the current repository truth that `L8` remains an `Alpha` memory layer centered on legacy-compatible `MemoryAtom / MemoryBundle / DecisionMemoryRecord` projection over a governed `Temporal Memory Field`, review-gated cold promotion, replay-visible continuity objects, and sovereign quarantine / sanctum / forget controls rather than a full `v∞` hippocampal well.
